    ...
    public partial class GameWindow : Window
    {
        ...
        public async Task StartDealing(bool playerStarts)
        {
            ...
            else
            {
                ...
                _vm.StatuszUzenet = $"A gép választott adut: {_vm.AduSzin}. Hívásra kész...";
                _vm.EnKovetkezem = false;
                _vm.FrissitBemondasLehetoseg();
                
                // A gép egyből hív az új körben, ha ő nyerte a sorsolást
                await GepHiv();
            }
        ...
        private async Task UtesKiErtekelese()
        {
         ...
         {
             if (!_jatekFolyamatban) return; // Ha már vége, ne spammeljunk
         ...
         private async void EndRound(bool playerWonRound)
         {
            ...
            // Sorsolunk hogy ki kezdi a kört
            ...
            if (playerStarts)
            {
                ...
                // Feldobjuk az aduválasztó ablakot a játékablak fölé
                var aduWindow = new AduValasztoWindow();
                aduWindow.Owner = this;
                var result = aduWindow.ShowDialog();
                if (result == true)
